...
//         e.preventDefault();
//         console.log(e);
//         setPreferredDecision({...preferredDecision});
...
//                         <br/>
//                         <input type='text' name='desired-decision' value={preferredDecision} placeholder='Enter result' 
//                         // onChange={e => setPreferredDecision(e.target.value)}
